...
public class TimerCmdEntry {
    ...
    public TimerCmdEntry(String perm, Boolean permValue, String playerCommand, List<String> consoleCommands, Boolean checkInv, String checkPlayer, List<String> bkupConsoleCommands) {
        this.perm = perm;
